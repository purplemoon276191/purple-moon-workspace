...
**Backend (Optional):** Express.js + TypeScript + TCB managed PostgreSQL (via CloudBase JS SDK)
...
- Node.js 18+
- (Optional) TCB managed PostgreSQL for backend
...
- TCB managed PostgreSQL (via CloudBase JS SDK)
