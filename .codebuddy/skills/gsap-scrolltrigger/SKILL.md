...
description: GSAP ScrollTrigger 滚动驱动动画能力 —— 滚动联动、pin 钉住、scrub 进度跟随、触发点配置。当需要做 Landing Page 滚动剧情、视差 parallax、长页面分段固定、滚动进度条联动元素时使用。framer-motion 的 scroll API 能力较弱，复杂滚动叙事必须用 ScrollTrigger。
license: MIT
---
